...
{
    public class CustomerConsoleThemes
    {
		public static CustomerConsoleTheme VisualStudioMacLight
		{
			get;
		} = new CustomerConsoleTheme(new Dictionary<ConsoleThemeStyle, string>
		{
