...
{
    public class CustomerConsoleTheme : ConsoleTheme
    {
        private readonly IReadOnlyDictionary<ConsoleThemeStyle, string> _styles;

        public CustomerConsoleTheme(IReadOnlyDictionary<ConsoleThemeStyle, string> styles)
        {
            if (styles == null)
            {
        ...
        public static CustomerConsoleTheme VisualStudioMacLight { get; } = CustomerConsoleThemes.VisualStudioMacLight;
