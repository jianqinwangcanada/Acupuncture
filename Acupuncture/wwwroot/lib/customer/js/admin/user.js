...
var copyBillingAddress = function (value) {
    ...
    if (type === "editForm") {
        ...
        loadCoppyShippingStates(_country, type);
    ...
    if (type === "addForm") {
        ...
        var city = $("#city").val();
        loadCoppyShippingStates(country,type);
        var state = $("#state").val();
...
/* Extention method to load states in coppy shiping options*/

function loadCoppyShippingStates(countryValue,type) {
